...
function Hometext(){
    return (
        ...
        <div className="maintext">
            ...
            <p>Get an AI-generated resume<br></br>
            based on your input,<br></br>instantly!</p>
            </div>
            ...
            <br></br><button className="bigbutton"> Get started</button>
            </div>
        ...
        <div className="offer">
            ...
            <button className="smallbutton"> Get started</button></div> 
